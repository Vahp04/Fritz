...
<body>
                            ...
                            <table class="table table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="user-avatar avatar-circle me-3">
    ...
    @else
        <form action="{{ route('usuario.toggle-status', $usuario->id) }}" method="POST" class="d-inline">
            @csrf
            <button type="submit" class="btn btn-sm {{ $usuario->activo ? 'btn-outline-warning' : 'btn-outline-success' }} action-btn me-1"
    ...
    <div class="modal fade" id="createUserModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('usuario.store') }}" method="POST" id="createUserForm">
                    @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center mb-4">
                        <div class="user-avatar mx-auto mb-3" style="width: 80px; height: 80px; font-size: 2rem;" id="view_avatar">
                            <!-- Avatar se llena con JavaScript -->
                        </div>
                        <h4 id="view_name"></h4>
    ...
    document.getElementById('editUserForm').action = `/usuario/${user.id}`;
        ...
        function viewUserData(user) {
            ...
            document.getElementById('view_status').innerHTML = user.activo ? 
                '<span class="badge bg-success">Activo</span>' : 
                '<span class="badge bg-secondary">Inactivo</span>';
            document.getElementById('view_created').textContent = new Date(user.created_at).toLocaleDateString('es-ES');
            document.getElementById('view_updated').textContent = new Date(user.updated_at).toLocaleDateString('es-ES');
